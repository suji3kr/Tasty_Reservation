		...
		<div class="filter-section">
			...
			<div class="filter-group">
				<label for="time">시 간</label> <select id="time" name="time">
					...
					<option value="all">종일 대여</option>
				</select>
			</div>

			<div class="filter-group">
				<label for="guests">예상 인원</label> <select id="guests" name="guests">
					<c:forEach var="num" begin="4" end="30">
						<option value="${num}">${num}명</option>
					</c:forEach>
					<option value="more">30명 이상</option>
			...
			<div class="filter-checkgroup">
				<label><b>파티룸 타입</b></label> <input type="checkbox" name="room-type"
					...
					name="room-type" value="terrace"> 테라스 <input
					type="checkbox" name="room-type" value="garden"> 정원 <input
					type="checkbox" name="room-type" value="pool"> 수영장 <input
...
<div class="pagination">
	...
	<c:if test="${pageMaker.prev}">
		<a
			href="/board/partyroom?pageNum=${pageMaker.startPage - 1}&amount=${amount}">이전</a>
	</c:if>
	...
	<c:forEach var="i" begin="${pageMaker.startPage}"
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="/board/partyroom?pageNum=${i}&amount=${amount}">${i}</a>
			</c:otherwise>
		</c:choose>
	</c:forEach>
	...
	<c:if test="${pageMaker.next}">
		<a
			href="/board/partyroom?pageNum=${pageMaker.endPage + 1}&amount=${amount}">다음</a>
	</c:if>
</div>
</html>

...
<div class="container">
    <div class="filter-section">
        ...
        <div class="filter-group">
            ...
            <input type="text" id="custom-guests" name="custom-guests" 
                   placeholder="아이포함 총인원 입력" style="display: none;">
        </div>

        <!-- 새로 추가된 키즈존 필터 -->
        <div class="filter-group">
            <label for="kids-zone">키즈존 여부</label>
            <select id="kids-zone" name="kids-zone">
        ...
        <div class="filter-stargroup">
            <label><b>별점 허용</b></label>
            <input type="radio" name="rating" value="5"> 5점
            <input type="radio" name="rating" value="4"> 4점대
            <input type="radio" name="rating" value="3"> 3점대
        </div>
        
        <div class="filter-checkgroup">
            <label><b>메 뉴</b></label>
            <input type="checkbox" name="food-type" value="western"> 양식
            <input type="checkbox" name="food-type" value="korean"> 한식
            <input type="checkbox" name="food-type" value="japanese"> 일식
            <input type="checkbox" name="food-type" value="chinese"> 중식
            <input type="checkbox" name="food-type" value="dessert"> 디저트/카페
        </div>
        
        <div class="filter-time-kids">
            <div class="filter-group">
                <label for="time">시 간</label>
...
<script>
	...
	// 키즈존 선택에 따른 처리
	document.getElementById('kids-zone').addEventListener('change', function() {
